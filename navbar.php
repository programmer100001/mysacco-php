...
<nav id="sidebar" class='mx-lt-5 bg-warning' >
		...
		<div class="sidebar-list">
				...
				<a href="index.php?page=payments" class="nav-item nav-payments"><span class='icon-field'><i class="fa fa-money-bill"></i></span> Contributions</a>
				...
				<a href="index.php?page=loan_type" class="nav-item nav-loan_type"><span class='icon-field'><i class="fa fa-th-list"></i></span> Dividents</a>		
